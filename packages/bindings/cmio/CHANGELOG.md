...
- e900240: Author the JavaScript half of the binding in TypeScript and generate the bundle and typings with tsup, instead of hand-writing `lib/index.js` alongside a separate `lib/index.d.ts`.
