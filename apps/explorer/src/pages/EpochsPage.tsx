        ...
        >
            <DataTable
                columns={[
                    ...
                    },
                    {
                        ...
                        cell: (e) => (
                            <span className="text-slate-600 dark:text-slate-300">
                                {formatUint(e.firstBlock)} –{" "}
                                {formatUint(e.lastBlock)}
                            </span>
                        ),
                    },
                    {
                    ...
                    {
                        header: "Virtual index",
                        align: "right",
                        cell: (e) => formatUint(e.virtualIndex),
                    },
                ...
                rowLink={(e) =>
                    `/apps/${appParam}/epochs/${uintToDecimal(e.index)}`
                }
