...
if (fromApp !== fromVocs) {
    console.error(
        [
            ...
            "",
            "This usually means a dependency shared with vocs resolved to two versions.",
            "Compare the two copies' node_modules to find the difference, then pin the",
            "offending package with an `overrides` entry in the root package.json.",
            "",
        ].join("\n"),
    );
    process.exit(1);
