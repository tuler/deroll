...
Emits a **report** — plain output data made available off-chain, *not* added to the outputs merkle tree. Reports cannot be proven or executed; they are free-form bytes for logs, diagnostics and [inspect](/rollup/guide/handling-requests#inspect-requests) responses.
