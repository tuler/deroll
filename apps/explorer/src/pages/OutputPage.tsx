...
export function OutputPage() {
    ...
    const output = useOutput({
        ...
        outputIndex: parseUintParam(outputIndex),
    });

    if (output.isPending) return <Spinner />;
    if (output.isError) return <ErrorBox error={output.error} />;
    const o = output.data;
        ...
        <div className="space-y-4">
                ...
                <KV
                    rows={[
                        ...
                        [
                            ...
                            <TxHash value={o.executionTransactionHash} full />,
                        ],
                        ...
                        rows={[
                            ...
                            outputDestination(decoded) !== undefined
                                ? [
                                      "Destination",
                                      <Hex
                                          value={outputDestination(decoded)}
                                          full
                                      />,
                                  ]
                                : null,
            ...
            <div className="space-y-2">
                ...
                >
                    ...
                    o.outputHashesSiblings.length > 0 ? (
                        <ol className="space-y-1 font-mono text-xs">
                            {o.outputHashesSiblings.map((h, i) => (
                                // biome-ignore lint/suspicious/noArrayIndexKey: sibling hashes are positional
