...
deroll is not involved in the loop at all. What it offers is libraries you plug in as handlers: the [wallet](/app/wallet) and the [router](/app/router/overview).
